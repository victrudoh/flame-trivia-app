          ...
          >
            ...
            <div className="flex flex-col gap-4 pt-auto justify-start mt-6">
              {authLoading ? (
                ...
                <button
                  type="submit"
                  className="transition-fx uppercase w-full h-[44px] bg-brand-main/20 cursor-pointer rounded-3xl flex items-center justify-center text-brand-white hover:bg-brand-main"
                >
                  Submit
                </button>
              )}
