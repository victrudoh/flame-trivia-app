...
const ChallengeEndCard = ({ data }: any) => {
  const { getLeaderboard }: any = useGeneralContext();
  ...
  return (
    <div className="flex flex-col items-center justify-start gap-6 bg-brand-white w-[90vw] max-w-screen-sm mx-auto rounded-xl px-4 py-8">
      ...
      <div className="rounded-xl w-full bg-brand-ash text-center font-medium text-sm flex flex-col gap-4 items-center justify-center p-8 border-brand-ash/40 border-[0.3px]">
        {/* <span
...
export default ChallengeEndCard;
