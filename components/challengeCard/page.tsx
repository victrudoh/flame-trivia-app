...
const ChallengeCard = ({
  ...
  const [timer, setTimer] = useState<number>(15); // 15 seconds timer
  ...
  const getColor = (percentage: number) => {
    ...
    if (percentage < 9) return "orange";
    if (percentage < 12) return "yellow";
    return "green";
  };
        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div className="w-12 h-12">
            <CircularProgressbar
              ...
              text={`${timer}`}
              styles={buildStyles({
                // pathColor: timer > 5 ? "blue" : "red",
                pathColor: getColor(timer),
                textColor: "#000",
                trailColor: "#d6d6d6",
                // textSize: "12px",
                textSize: "32px",
